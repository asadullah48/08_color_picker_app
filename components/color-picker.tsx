  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-orange-400 to-yellow-400">
      ...
      <Card className="w-full max-w-md mx-auto p-8 shadow-lg rounded-lg">
        ...
        <CardTitle className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-yellow-700 bg-clip-text text-transparent">
            Color Picker
          </CardTitle>
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-2 text-center">
            ...
            <Button
              ...
              variant="default"
              className="w-full bg-blue-500 hover:bg-blue-600 text-green font-bold py-2 rounded-md transition-colors duration-300"
            >
              Copy to Clipboard
            </Button>
          </div>
      ...
      <div className="text-yellow font-medium mt-8">
