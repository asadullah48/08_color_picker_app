...
export default function ColorPickerComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-yellow-400 to-darkblue-400">
      ...
      <Card className="w-full max-w-md mx-auto p-8 shadow-lg rounded-lg">
        ...
        <CardTitle className="text-3xl font-bold bg-gradient-to-r from-blue-500 to-darkblue-700 bg-clip-text text-transparent">
            Color Picker
          </CardTitle>
