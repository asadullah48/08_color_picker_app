...
export default function ColorPickerComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-yellow-400 to-orange-400">
      ...
      <Card className="w-full max-w-md mx-auto p-8 shadow-lg rounded-lg">
        ...
        <CardTitle className="text-3xl font-bold bg-gradient-to-r from-yellow-500 to-orange-700 bg-clip-text text-transparent">
            Color Picker
          </CardTitle>
          <CardDescription className="text-brow-500">
        ...
        <div className="grid gap-4">
          ...
          <div
            className="w-full h-48 rounded-lg border-4 border-green-300"
            style={{ backgroundColor: color }}
          />
          {/* Display the color value in hex and RGB format, and button to copy */}
          <div className="grid gap-2 text-center">
            <div className="text-2xl font-semibold text-green-900">{color}</div>
            <div className="text-gray-500 dark:text-green-400">
            ...
            <Button
              ...
              variant="default"
              className="w-full bg-brown-500 hover:bg-brown-600 text-yellow font-bold py-2 rounded-md transition-colors duration-300"
            >
              Copy to Clipboard
            </Button>
          </div>
